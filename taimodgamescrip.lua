...
shared.LoaderTitle = "Đăng Ký Kênh Tài mod game";
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=14118557209";
v24.Parent = v23;
    ...
    function getHighestPoint()
        ...
        for v728, v729 in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v729:IsA("MeshPart") then
                if (v729.MeshId == "rbxassetid://14118557209") then
                    return v729;
                end
            end
        end
