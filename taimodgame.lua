...
v0.new("<Color=Cyan>Welcome to Tài mod game Hub<Color=/>"):Display();
wait(0.5);
...
v5.Window = function(v134, v135)
	...
	v170.Image = "http://www.roblox.com/asset/?id="   .. tostring(14118557209) ;
...
v8.Image = "rbxassetid://14118557209";
v8.Draggable = true;
...
game:GetService("StarterGui"):SetCore("SendNotification", {
	Title = "Tài mod game Hub",
	Text = "Loading...",
	Icon = "rbxthumb://type=Asset&id=14118557209&w=150&h=150",
	Duration = 10
});
spawn(function()
	while wait() do
